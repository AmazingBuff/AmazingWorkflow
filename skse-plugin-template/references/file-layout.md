...
pch.h holds stable, widely used base headers; it may include the third-party
headers actually used (CommonLib, SKSE, fmt, etc.), follows the lightweight
cpp-style, and includes the build-generated plugin.h. Metadata comes from
the root CMake's PROJECT_NAME, PROJECT_VERSION, PROJECT_NAMESPACE, and
PROJECT_AUTHOR; do not copy project name/version strings across modules.
